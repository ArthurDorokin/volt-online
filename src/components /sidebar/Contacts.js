            ...
            <div className="article-text">
                <div className="sidebar-article">
                    <ul className="sideMenu-list">
                        ...
                        <li className="sideMenu-i">
                            <div className="sideMenu-t active"><a href="/contacts/">Контактная
                                информация</a></div>
                        </li>
                    ...
                    <div className="wrap">
                        <div className="info">
                            <div className="num">
                                ...
                                <p><a href="tel:044 000-00-00">044 000-00-00</a></p>
                                <p><a href="tel:095 000-00-00">095 000-00-00</a></p>
                            </div>
                            <p className="mail">
                                ...
                                <a href="mailto:mail@mail.com">mail@mail.com</a></p>
                            <p className="skype">
